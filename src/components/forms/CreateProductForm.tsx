        ...
        <form onSubmit={form.handleSubmit(handleProductFormSubmit)}>
          ...
          <div className="grid gap-6 sm:grid-cols-6">
            <div className="flex flex-col gap-5 sm:col-span-4">
              {/* Product Details */}
              <Card>
                <CardHeader className="pb-2 mb-4 bg-gray-100 p-4 rounded-tl-lg rounded-tr-lg">
                  <CardTitle className="text-zinc-800 uppercase tracking-wider text-base">
                    Product Details
                  </CardTitle>
                </CardHeader>
                <CardContent>
              ...
              {/* Shipping */}
              <Card>
                <CardHeader className="pb-2 bg-gray-100 p-4 rounded-tl-lg rounded-tr-lg mb-4">
                  <CardTitle className="text-zinc-800 uppercase tracking-wider text-base">
                    Shipping
                  </CardTitle>
                  <CardDescription>
